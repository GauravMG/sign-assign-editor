...
import { Application, settings, Sprite, Loader, LoaderResource, Texture, Resource } from 'pixi.js';
...
class PlaybackController {
   ...
   */
  private applySpriteOptions = (sprite: Sprite, options: Record<string, any>) => {
    ...
    return new Promise((resolve) => {
      loader.load((loader, resources) => {
        for (const [key, resource] of Object.entries(resources)) {
          ...
          let texture: Texture<Resource> = Texture.from(object)

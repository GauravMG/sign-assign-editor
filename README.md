...
重要：必须使用 pnpm 8.x，高版本 pnpm 会导致依赖不一致出现页面运行报错。
...
<a href="https://new.kuaitu.cc/#/store"  target="_blank">商品 DIY 设计器</a> · <a href="https://ws0gdejldw.feishu.cn/docx/P8ZGdHQ9OoGxcaxyFYecXwO9nig?from=from_copylink"  target="_blank">DIY 产品介绍</a></p>
